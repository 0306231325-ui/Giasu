    ...
    <div className="min-h-screen bg-[#0b1026] text-white flex">
      ...
      <aside className="w-72 shrink-0 border-r border-white/10 bg-[#0a0f24]">
        ...
        <nav className="p-3 space-y-1">
          ...
          <NavItem to="/admin/yeu-cau-dat-gia-su" label="Yêu cầu đặt gia sư" />
      ...
      <div className="flex-1 min-w-0">
        <header className="h-16 flex items-center justify-between px-6 border-b border-white/10 bg-[#0a0f24]">
