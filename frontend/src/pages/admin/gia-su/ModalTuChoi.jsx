            ...
            <div className="w-full max-w-lg rounded-2xl bg-white p-6 text-slate-900 shadow-2xl">
                ...
                <div className="mt-5 flex justify-end gap-3">
                    <button
                        ...
                        onClick={onDong}
                        disabled={dangXuLy}
                        className="rounded-xl border border-slate-200 px-4 py-2.5 text-sm font-bold text-slate-600 disabled:cursor-not-allowed disabled:opacity-60"
                    >
                        Hủy
                    </button>
                    <button
                        ...
                        className="rounded-xl bg-red-600 px-4 py-2.5 text-sm font-bold text-white disabled:cursor-not-allowed disabled:opacity-50"
                    >
